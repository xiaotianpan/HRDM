...
def get_args(description='whl'):
    ...
    parser.add_argument('--embed_dim',
                        default=512, type=int, metavar='DIM',
    ...
    parser.add_argument('--attn_heads',
                        default=32, type=int, metavar='NUM_HEADS',
    ...
    parser.add_argument('--root_dir',
                        default='crosstask_release', type=str,
                        help='root dir')
    parser.add_argument('--train_json',
                        default='cross_task_data_False.json', type=str,
                        help='train json file')
    parser.add_argument('--valid_json',
                        default='cross_task_data_True.json', type=str,
                        help='valid json file')
    parser.add_argument('--features_dir',
                        default='processed_data', type=str,
                        help='features dir')
